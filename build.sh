...
!
    ...
    $SED -i '' -e '/^wine_fn_config_program/s/,installbin//' configure
    $SED -i '' -e '/^wine-installed: main.o wine_info.plist/{n;s|$| -Wl,-rpath,/opt/X11/lib -Wl,-rpath,/usr/lib|;}' configure
}
